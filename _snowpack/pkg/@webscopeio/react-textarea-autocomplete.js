...
var ReactTextareaAutocomplete = /* @__PURE__ */ function(_React$Component2) {
  ...
  function ReactTextareaAutocomplete2(_props) {
    ...
    _this2._onSelect = function(item) {
      ...
      var _this2$props = _this2.props, trigger = _this2$props.trigger, onItemSelected = _this2$props.onItemSelected;
      if (!currentTrigger)
        return;
      ...
      var startOfTokenPosition = textToModify.search(new RegExp("".concat(escapeRegex(currentTrigger), "[^".concat(escapeRegex(currentTrigger)).concat(trigger[currentTrigger].allowWhitespace ? "" : "\\s", "]"), "*$")));
    ...
    _this2._changeHandler = function(e) {
      var _this2$props2 = _this2.props, trigger = _this2$props2.trigger, onChange = _this2$props2.onChange, minChar = _this2$props2.minChar, onCaretPositionChange = _this2$props2.onCaretPositionChange, movePopupAsYouType = _this2$props2.movePopupAsYouType;
    ...
    _this2._selectHandler = function(e) {
      var _this2$props3 = _this2.props, onCaretPositionChange = _this2$props3.onCaretPositionChange, onSelect = _this2$props3.onSelect;
      if (onCaretPositionChange) {
        var caretPosition = _this2.getCaretPosition();
        onCaretPositionChange(caretPosition);
      }
    ...
    _this2.escListener = null;
    var _this2$props4 = _this2.props, loadingComponent = _this2$props4.loadingComponent, _trigger = _this2$props4.trigger, _value = _this2$props4.value;
    if (_value)
