...
import {a as _typeof, b as _inherits, c as _classCallCheck, d as _createClass, e as _objectWithoutProperties, f as _toConsumableArray} from "./common/typeof-aa35ec49.js";
  ...
  do {
    switch (R(character)) {
      case 0:
        ...
        parsed[index2] += re(E - 1);
        break;
      case 2:
        parsed[index2] += V(character);
        break;
      case 4:
        if (character === 44) {
          parsed[++index2] = N() === 58 ? "&\f" : "";
