...
export const Pane = () => {
  ...
  const renderCategories = () => {
    return /* @__PURE__ */ React.createElement(MenuContainer, null, getEnabledMenus().map(({label}) => /* @__PURE__ */ React.createElement(SubmenuRow, {
  ...
  const renderSelectedCategory = (keycodes, selectedCategory2) => {
    ...
    switch (selectedCategory2) {
      ...
      case "Custom": {
        if (!isVIADefinitionV2(selectedDefinition) || !selectedDefinition.customKeycodes) {
          return null;
        }
