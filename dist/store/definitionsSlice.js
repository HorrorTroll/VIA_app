...
export const getSelectedOptionKeys = createSelector(getSelectedLayoutOptions, getSelectedDefinition, (layoutOptions, definition) => definition && layoutOptions.flatMap((option, idx) => definition.layouts.optionKeys[idx][option]));
